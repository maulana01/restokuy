...
<body>
  ...
  <main class="container-fluid">
    <div class="row">
      ...
      <div class="col">
        <h1 class="text-center mt-5 mb-4 font-primary">Selamat Datang, Admin</h1>
        ...
        <div class="row justify-content-evenly">
          <div class="col-2 bg--four p-3">
            <div class="row">
              <div class="col text-center m-auto">
                <span class="fs-1 fw-bold font-secondary"><?php totalPelayan(); ?></span>
              </div>
          ...
          <div class="col-2 bg--four p-3">
            <div class="row">
              <div class="col text-center m-auto">
                <span class="fs-1 fw-bold font-secondary"><?php totalMenu(); ?></span>
              </div>
              <div class="col text-center">
                <div class="row">
                  <div class="col">
          ...
          <div class="col-2 bg--four p-3">
            <div class="row">
              <div class="col text-center m-auto">
                <span class="fs-1 fw-bold font-secondary"><?php totalKoki(); ?></span>
              </div>
              <div class="col text-center">
                <div class="row">
                  <div class="col">
          ...
          <div class="col-2 bg--four p-3">
            <div class="row">
              <div class="col text-center m-auto">
                <span class="fs-1 fw-bold font-secondary"><?php totalKasir(); ?></span>
              </div>
              <div class="col text-center">
                <div class="row">
                  <div class="col">
                ...
                <div class="col-4">
                  <div class="card cards p-3 card-shadow">
                    ...
                    <div class="card-body">
                      ...
                      <a href="./menu/menu.php" class="btn bg--third font-btn font-primary d-block col-6 mx-auto">lihat</a>
                    </div>
                  </div>
                </div>
              </div>
