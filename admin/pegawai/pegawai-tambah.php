  ...
  <main class="container-fluid">
    <div class="row">
      ...
      <div class="col m-5">
        ...
        <a href="./pegawai.php" class="btn font-btn bg--third font-white my-4">Kembali</a>

        <?php tambahDataPegawai(); ?>
        ...
        <form method="post" action="">
          ...
          <div class="row mb-3">
            ...
            <div class="col-auto">
              <input type="text" class="form-control" id="exampleNoHp" name="no_hp" required>
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-2">
