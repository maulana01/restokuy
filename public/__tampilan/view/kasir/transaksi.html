    ...
    <div class="row">
      <div class="col-2 bg--third side" id="sidebars">
        <ul class="nav flex-column my-3 nav-sidebar">
          <li>
            <a href="./dashboard.html" class="nav-link font-primary">
          ...
          <li>
            <a href="./transaksi.html" class="nav-link font-primary">
              <img src="./../../img/icon-pembayaran.svg" alt="Dashboard" class="pb-2">
              <span class="fw-bold"> Pembayaran</span>
            </a>
          </li>
          <li>
            <a href="./rekapitulasi.html" class="nav-link font-primary">
