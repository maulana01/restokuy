...
<body>
  ...
  <main class="container-fluid">
    <div class="row">
      ...
      <div class="col">
        <h1 class="text-center mt-5 mb-4 font-primary">Selamat Datang, Kasir.</h1>
                ...
                <div class="row justify-content-center">
                  <div class="col-4">
                    <div class="card cards p-3 card-shadow">
                      <img src="./../../img/bg_pembayaran.png" class="card-img-top m-auto" alt="pembayaran">
                      <div class="card-body">
                        ...
                        <br>
                        <a href="./transaksi.php" class="btn bg--third font-btn font-primary d-block col-6 mx-auto">lihat</a>
                      </div>
                    </div>
                  </div>
                  <div class="col-4">
                    <div class="card cards p-3 card-shadow">
                      <img src="./../../img/bg_rekapitulasi.png" class="card-img-top m-auto" alt="rekapitulasi">
                      <div class="card-body">
                        ...
                        <br>
                        <a href="./rekapitulasi.php" class="btn bg--third font-btn font-primary d-block col-6 mx-auto">lihat</a>
                      </div>
                    </div>
                  </div>
                </div>
